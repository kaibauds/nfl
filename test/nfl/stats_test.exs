defmodule Nfl.StatsTest do
  ...
  describe "rushing_data" do
    ...
    @valid_attrs %{attempts: 42, attempts_per_game: "120.5", first_down_percentage: "120.5", first_downs: 42, forty_yards: 42, fum: 42, longest_rush: 42, rushing_yards: 42, rushing_yards_per_attempt: "120.5", rushing_yards_per_game: "120.5", touchdowns: 42, twenty_yards: 42}
